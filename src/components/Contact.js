                    ...
                    <Col md={6}>
                        ...
                        <form onSubmit={handleSubmit}>
                            <Row>
                                ...
                                <Col className="col-12 px-1">
                                    <textarea cols="30" rows="6" value={formDetails.message} placeholder="Email Message" onChange={(e) => {onFormUpdate('message', e.target.value)}}></textarea>
